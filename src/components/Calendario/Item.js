        ...
        <div className="col">
            <div className="card border-primary shadow-lg bg-white rounded">
                ...
                <ul className="list-group list-group-flush">
                    <li className="list-group-item">Calorias maximas al dia: {dia.caloriasMaximasAlDia}</li>
                    <li className="list-group-item">Calorias consumidas este dia: {dia.caloriasConsumidasDia}</li>
                </ul>
